...
const activeDot=function(slide){
  ...
  // dot.dataset[slide].classList.add("dots__dot--active");
...
// const dot=document.querySelector(`.dots__dot[data-slide="1"]`);
// console.log(dot);
// const test=document.querySelector('.dots__dot');
// console.log(test.dataset.slide==0);
